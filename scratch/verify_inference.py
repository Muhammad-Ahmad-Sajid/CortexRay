...
fractured_scans = df[df['has_fracture'] == True].reset_index(drop=True)
...
print(f"[*] Expected bone: {sample_scan['bone_affected']}, Expected severity: {sample_scan['severity_class']}")
