...
def main():
    ...
    has_body_part = "body_part" in first_annotation or "body_part" in first_image or "body_part" in first_image.get("metadata", {})
    ...
    severity_map = {
        "stress": "hairline", "hairline": "hairline",
        "transverse": "simple", "oblique": "simple", "spiral": "simple",
        "displaced": "displaced", "avulsion": "displaced",
        "comminuted": "comminuted", "segmental": "comminuted"
    }
    
    bone_map = {
        "wrist": "distal_radius", "radius": "distal_radius", "distal radius": "distal_radius",
        "clavicle": "clavicle", "collarbone": "clavicle",
        "ankle": "ankle", "fibula": "ankle", "tibia": "ankle",
        "femur": "femur", "thigh": "femur",
        "humerus": "humerus", "upper arm": "humerus",
        "foot": "metatarsal", "metatarsal": "metatarsal", "toe": "metatarsal"
    }
