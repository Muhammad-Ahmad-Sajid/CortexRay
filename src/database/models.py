...
class Patient(Base):
    ...
    full_name = Column(
        String(255), 
        nullable=False, 
        comment="Full legal name of the patient"
    )
    age = Column(
        Integer, 
        nullable=False, 
        comment="Age of the patient in years"
    )
    gender = Column(
        String(50), 
        nullable=False, 
...
class FracturePrediction(Base):
    ...
    confidence_score = Column(
        Float, 
        nullable=False, 
        comment="Prediction confidence score between 0.0 and 1.0"
    )
    heatmap_path = Column(
        String(512), 
        nullable=True, 
...
class PrognosisResult(Base):
    ...
    override_notes = Column(
        Text, 
        nullable=True, 
        comment="Reason or notes for the clinician override"
    )
